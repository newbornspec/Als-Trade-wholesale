...
export default function StockPage() {
  useSeo({ title: 'Available Wholesale IT Hardware Stock', description: 'Browse current batches of wholesale and refurbished IT hardware — laptops, computers and monitors — available to trade buyers. New stock added regularly.', path: '/available-stock' });
  ...
  /* ItemList structured data — lets search engines see the listing as an
     ordered set of product URLs rather than an opaque page. */
  useEffect(() => {
      ...
      <div className="container stock-body">
        ...
        <div className="stock-layout">
          ...
          <aside className={`stock-sidebar ${sidebarOpen ? 'open' : ''}`}>
            ...
            {/* Filters */}
            <div className="sb-section">
              <p className="sb-label">Condition</p>
            ...
            <div className="sb-promo">
              ...
              <p>Subscribe to see prices on every batch instantly.</p>
              {!user && (
            ...
            <div className="sb-contact">
              ...
              <a href={whatsappLink()} target="_blank" rel="noreferrer" className="wa-link">
