...
export default function SignUpPage() {
  ...
  const isValid =
    form.name && form.companyName && form.email && form.phone &&
        ...
        <div className="auth-brand-inner">
          ...
          <div className="auth-brand-copy">
            <h2 className="auth-brand-title">
              Join hundreds of<br/>
              <span style={{ color: 'var(--accent)' }}>B2B buyers.</span>
            </h2>
            <p className="auth-brand-sub">
              Register your company for free and get instant access to
              live pricing on all available batches.
            </p>
          </div>
        ...
        <div className="auth-form-inner" style={{ maxWidth: '480px' }}>
          ...
          <div className="auth-card">
            ...
            <div className="b2b-notice">
              ...
              Private individuals cannot create an account.
            </div>

            {/* Error banner */}
            {errMsg && (
              <div className="auth-error" style={{ margin: '1rem 1.75rem 0' }}>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" strokeWidth="2">
                  <circle cx="12" cy="12" r="10"/>
                  <line x1="12" y1="8" x2="12" y2="12"/>
                ...
                {errMsg.includes('already exists') && (
                  <Link to="/sign-in" style={{ color:'var(--accent)', marginLeft:'6px', fontWeight:600 }}>
                    Log in →
                  </Link>
                )}
              </div>
            ...
            <form className="auth-form register-form" onSubmit={submit} noValidate>
                  ...
                  <div className="pw-strength">
                    <div className="pw-bars">
                      {strength.bars.map((cls, i) => (
                        <div key={i} className={`pw-bar ${cls}`} />
                      ))}
                    </div>
                    <span className="pw-label" style={{
                      color: strength.score <= 1 ? '#e74c3c'
                           : strength.score <= 2 ? 'var(--accent)'
                           : '#4cdb80'
                    }}>
                      {strength.label}
                    </span>
              ...
              >
                ...
                <p>
                  I confirm that I am registering on behalf of a registered business and
                  agree to the{' '}
                  <Link
                    to="/contact"
